...
def export(
    ...
    # Pull cached Google NashDigs packages for packages_view + by_package slices.
    ...
    manifest = write_exports(
        ...
        now_ct=now_ct,
        db_stats=stats,
        nashdigs_google_packages=google_packages,
    )
...
def write_exports(
    ...
    nashdigs_google_packages: list | None = None,
) -> ExportManifest:
    ...
    # NashDigs packages_view — one row per Google package with ticket aggregates
    packages_path = out_dir / "packages_view.csv"
    packages_list = nashdigs_google_packages or []
...
def _write_packages_view_csv(
    ...
    """One row per Google-owned NashDigs package, with ticket aggregates.
